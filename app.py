...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/DebeshPanda555/Draft.io' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/debesh-kumar-panda-4a299a273/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Debesh Panda</b>
                </a>
            </p>
            """, unsafe_allow_html=True)
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/DebeshPanda555/)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [The Cube](https://github.com/DebeshPanda555/)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <h2 class="profile-name">Debesh Panda</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/DebeshPanda555" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/debesh-kumar-panda-4a299a273/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:itsdkp555@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Developer with expertise in AI and Machine Learning.
                    I created Draft.io to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Draft.io represents my vision of democratizing career advancement through technology.
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/DebeshPanda555)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [E-commerce website](https://github.com/DebeshPanda555)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [Smart-Expense Tracker](https://github.com/DebeshPanda555)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [Noir Bites](https://github.com/DebeshPanda555)", icon="ℹ️")
